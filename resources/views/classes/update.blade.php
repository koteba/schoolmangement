                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="chart-area">
                            <form action="{{ route('classes.update',$classes->classes_id) }}" method="POST" enctype="multipart/form-data">
                                @csrf

                                @method('PUT')
                                <div class="mb-3">
                                    <label for="name" class="form-label">الصف <i class="text-danger"> * </i>:</label>
                                    <input type="text" name="name" id="name" class="form-control" value="{{$classes->name }}">
                                </div>

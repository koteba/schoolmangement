                ...
                <div class="card-body">
                    <div class="chart-area">
                        <div class="mb-3">
                            ...
                            <input type="text" readonly name="name" id="name" class="form-control" value="{{isset($classes)? $classes->name :""}}">
                        </div>

                        <div class="row">
                            <div class="col-md-2" >
                                <form action="{{route('classes.destroy',$classes->classes_id)}}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                        ...
                                        <div class="modal-dialog modal-confirm">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                  <p>هل تريد حذف الصف المحدد بشكل نهائي.</p>
                                                 </div>

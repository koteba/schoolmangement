        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
                <div class="card-header pt-3 pb-1">
                    <h6 class="m-0 font-weight-bold text-primary" style="font-family: doridregular, Arial !important;font-size: 18px;"><strong>تفاصيل مدرس</strong></h6>
                </div>
                <hr>
                <div class="card-body">
                    <div class="chart-area">
                        <div class="mb-3">
                            ...
                            <input type="text" readonly name="name" id="name" class="form-control" value="{{isset($teacher)? $teacher->name :""}}">
                        </div>
                        <div class="mb-3">
                            <label for="address" class="form-label">العنوان </label>
                            <input type="text" readonly name="address" id="address" class="form-control" value="{{isset($teacher)? $teacher->address :""}}">
                        </div>
                                        ...
                                        <div class="modal-dialog modal-confirm">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                  <p>هل تريد حذف المدرس المحدد بشكل نهائي.</p>
                                                 </div>
